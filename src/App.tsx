...
export const App: React.FC = () => {
  ...
  const SANDBOX_ENEMY_GROUPS: { label: string; types: EnemyType[] }[] = [
    ...
    // Arena room families: four per room — the Man, the Bulwark that walls
    // you in, the Slinger that punishes standing still, and the room-only
    // special. Grouped by tier because 38 rooms is too many headings.
    { label: 'Rooms · Tier 1', types: ['sandNative', 'sandBulwark', 'sandSlinger', 'sandPrime', 'rockNative', 'rockBulwark', 'rockSlinger', 'rockPrime', 'grassNative', 'grassBulwark', 'grassSlinger', 'grassPrime', 'dirtNative', 'dirtBulwark', 'dirtSlinger', 'dirtPrime', 'waterNative', 'waterBulwark', 'waterSlinger', 'waterPrime', 'snowNative', 'snowBulwark', 'snowSlinger', 'snowPrime', 'badlandsNative', 'badlandsBulwark', 'badlandsSlinger', 'badlandsPrime', 'gardenNative', 'gardenBulwark', 'gardenSlinger', 'gardenPrime'] },
    { label: 'Rooms · Tier 2', types: ['magmaNative', 'magmaBulwark', 'magmaSlinger', 'magmaPrime', 'caveNative', 'caveBulwark', 'caveSlinger', 'cavePrime', 'darkConcreteNative', 'darkConcreteBulwark', 'darkConcreteSlinger', 'darkConcretePrime', 'volcanoNative', 'volcanoBulwark', 'volcanoSlinger', 'volcanoPrime', 'burntHouseNative', 'burntHouseBulwark', 'burntHouseSlinger', 'burntHousePrime', 'amethystNative', 'amethystBulwark', 'amethystSlinger', 'amethystPrime', 'ironNative', 'ironBulwark', 'ironSlinger', 'ironPrime', 'copperNative', 'copperBulwark', 'copperSlinger', 'copperPrime'] },
    { label: 'Rooms · Tier 3', types: ['goldNative', 'goldBulwark', 'goldSlinger', 'goldPrime', 'rainbowNative', 'rainbowBulwark', 'rainbowSlinger', 'rainbowPrime', 'blueNative', 'blueBulwark', 'blueSlinger', 'bluePrime', 'bloodNative', 'bloodBulwark', 'bloodSlinger', 'bloodPrime', 'darkOceanNative', 'darkOceanBulwark', 'darkOceanSlinger', 'darkOceanPrime', 'nightNative', 'nightBulwark', 'nightSlinger', 'nightPrime', 'galaxyNative', 'galaxyBulwark', 'galaxySlinger', 'galaxyPrime'] },
    { label: 'Rooms · Tier 4', types: ['diamondNative', 'diamondBulwark', 'diamondSlinger', 'diamondPrime', 'assassinNative', 'assassinBulwark', 'assassinSlinger', 'assassinPrime', 'pitchBrawlNative', 'pitchBrawlBulwark', 'pitchBrawlSlinger', 'pitchBrawlPrime', 'platinumNative', 'platinumBulwark', 'platinumSlinger', 'platinumPrime', 'glassNative', 'glassBulwark', 'glassSlinger', 'glassPrime', 'clearNative', 'clearBulwark', 'clearSlinger', 'clearPrime', 'illusionNative', 'illusionBulwark', 'illusionSlinger', 'illusionPrime'] },
    { label: 'Rooms · Tier 5', types: ['nightmareNative', 'nightmareBulwark', 'nightmareSlinger', 'nightmarePrime', 'pitchBlackNative', 'pitchBlackBulwark', 'pitchBlackSlinger', 'pitchBlackPrime', 'boneNative', 'boneBulwark', 'boneSlinger', 'bonePrime', 'rustNative', 'rustBulwark', 'rustSlinger', 'rustPrime', 'riftNative', 'riftBulwark', 'riftSlinger', 'riftPrime', 'blackIceNative', 'blackIceBulwark', 'blackIceSlinger', 'blackIcePrime', 'furnaceNative', 'furnaceBulwark', 'furnaceSlinger', 'furnacePrime', 'hollowNative', 'hollowBulwark', 'hollowSlinger', 'hollowPrime'] },
  ...
  const ENEMY_LABELS: Partial<Record<EnemyType, string>> = {
    ...
    // Arena room family labels
    sandNative: 'Sand Man',
    sandBulwark: '🧱 Sand Bulwark',
    sandSlinger: '🎯 Sand Slinger',
    sandPrime: '⭐ Dune Warden',
    rockNative: 'Rock Man',
    rockBulwark: '🧱 Rock Brute',
    rockSlinger: '🎯 Rock Slinger',
    rockPrime: '⭐ Rock Colossus',
    grassNative: 'Grass Man',
    grassBulwark: '🧱 Thicket',
    grassSlinger: '🎯 Seed Slinger',
    grassPrime: '⭐ Bramble King',
    dirtNative: 'Dirt Man',
    dirtBulwark: '🧱 Mudpacked',
    dirtSlinger: '🎯 Clod Thrower',
    dirtPrime: '⭐ Burrower',
    waterNative: 'Tide Man',
    waterBulwark: '🧱 Undertow',
    waterSlinger: '🎯 Spray',
    waterPrime: '⭐ Riptide',
    snowNative: 'Ice Man',
    snowBulwark: '🧱 Snowpack',
    snowSlinger: '🎯 Hailer',
    snowPrime: '⭐ Blizzard Warden',
    badlandsNative: 'Badlands Man',
    badlandsBulwark: '🧱 Mesa',
    badlandsSlinger: '🎯 Ridge Shot',
    badlandsPrime: '⭐ Canyon Sniper',
    gardenNative: 'Garden Man',
    gardenBulwark: '🧱 Hedge',
    gardenSlinger: '🎯 Pollen',
    gardenPrime: '⭐ Gardener',
    magmaNative: 'Magma Man',
    magmaBulwark: '🧱 Slagheap',
    magmaSlinger: '🎯 Ember Thrower',
    magmaPrime: '⭐ Magma Lord',
    caveNative: 'Cave Man',
    caveBulwark: '🧱 Stalagmite',
    caveSlinger: '🎯 Rock Lobber',
    cavePrime: '⭐ Cave Stalker',
    darkConcreteNative: 'Rebar Man',
    darkConcreteBulwark: '🧱 Pillar',
    darkConcreteSlinger: '🎯 Rivet Gun',
    darkConcretePrime: '⭐ Foreman',
    volcanoNative: 'Cinder Man',
    volcanoBulwark: '🧱 Basalt',
    volcanoSlinger: '🎯 Firebomb',
    volcanoPrime: '⭐ Eruption',
    burntHouseNative: 'Ash Man',
    burntHouseBulwark: '🧱 Charred Frame',
    burntHouseSlinger: '🎯 Ember Spit',
    burntHousePrime: '⭐ Cinder Wraith',
    amethystNative: 'Amethyst Man',
    amethystBulwark: '🧱 Cluster',
    amethystSlinger: '🎯 Shard Slinger',
    amethystPrime: '⭐ Geode',
    ironNative: 'Iron Man',
    ironBulwark: '🧱 Anvil',
    ironSlinger: '🎯 Bolt Thrower',
    ironPrime: '⭐ Loadstone',
    copperNative: 'Copper Man',
    copperBulwark: '🧱 Ingot',
    copperSlinger: '🎯 Arc Thrower',
    copperPrime: '⭐ Live Wire',
    goldNative: 'Gold Man',
    goldBulwark: '🧱 Bullion',
    goldSlinger: '🎯 Coin Slinger',
    goldPrime: '⭐ Gilded Champion',
    rainbowNative: 'Prism Man',
    rainbowBulwark: '🧱 Spectrum Wall',
    rainbowSlinger: '🎯 Refractor',
    rainbowPrime: '⭐ Spectrum',
    blueNative: 'Cobalt Man',
    blueBulwark: '🧱 Cobalt Wall',
    blueSlinger: '🎯 Bolt Caster',
    bluePrime: '⭐ Deep Cobalt',
    bloodNative: 'Blood Man',
    bloodBulwark: '🧱 Clot',
    bloodSlinger: '🎯 Bleeder',
    bloodPrime: '⭐ Exsanguinator',
    darkOceanNative: 'Abyss Man',
    darkOceanBulwark: '🧱 Trench',
    darkOceanSlinger: '🎯 Deep Caster',
    darkOceanPrime: '⭐ Leviathan',
    nightNative: 'Night Man',
    nightBulwark: '🧱 Nightwall',
    nightSlinger: '🎯 Star Caster',
    nightPrime: '⭐ Nightfall',
    galaxyNative: 'Galaxy Man',
    galaxyBulwark: '🧱 Nebula',
    galaxySlinger: '🎯 Comet',
    galaxyPrime: '⭐ Singularity',
    diamondNative: 'Diamond Man',
    diamondBulwark: '🧱 Facet',
    diamondSlinger: '🎯 Prism Cutter',
    diamondPrime: '⭐ Brilliant',
    assassinNative: 'Shadow Assassin',
    assassinBulwark: '🧱 Bodyblock',
    assassinSlinger: '🎯 Dartcaster',
    assassinPrime: '⭐ Nightblade',
    pitchBrawlNative: 'Striker',
    pitchBrawlBulwark: '🧱 Sweeper',
    pitchBrawlSlinger: '🎯 Winger',
    pitchBrawlPrime: '⭐ Striker Captain',
    platinumNative: 'Platinum Man',
    platinumBulwark: '🧱 Bulkhead',
    platinumSlinger: '🎯 Deflector',
    platinumPrime: '⭐ Mirrorplate',
    glassNative: 'Glass Man',
    glassBulwark: '🧱 Pane',
    glassSlinger: '🎯 Splinter',
    glassPrime: '⭐ Shatterpane',
    clearNative: 'Clear Man',
    clearBulwark: '🧱 Clear Wall',
    clearSlinger: '🎯 Faint Shot',
    clearPrime: '⭐ Ghostpane',
    illusionNative: 'Mirage Man',
    illusionBulwark: '🧱 False Wall',
    illusionSlinger: '🎯 Echo',
    illusionPrime: '⭐ Illusionist',
    nightmareNative: 'Nightmare Man',
    nightmareBulwark: '🧱 Dread',
    nightmareSlinger: '🎯 Whisper',
    nightmarePrime: '⭐ Night Terror',
    pitchBlackNative: 'Void Man',
    pitchBlackBulwark: '🧱 Blackout',
    pitchBlackSlinger: '🎯 Nothing',
    pitchBlackPrime: '⭐ The Unseen',
    boneNative: 'Bone Man',
    boneBulwark: '🧱 Ribcage',
    boneSlinger: '🎯 Marrow',
    bonePrime: '⭐ Ossuary King',
    rustNative: 'Rust Man',
    rustBulwark: '🧱 Scrapheap',
    rustSlinger: '🎯 Shrapnel',
    rustPrime: '⭐ Corroder',
    riftNative: 'Rift Man',
    riftBulwark: '🧱 Tearwall',
    riftSlinger: '🎯 Riftcaster',
    riftPrime: '⭐ The Opening',
    blackIceNative: 'Black Ice Man',
    blackIceBulwark: '🧱 Glacier',
    blackIceSlinger: '🎯 Sleet',
    blackIcePrime: '⭐ The Long Cold',
    furnaceNative: 'Furnace Man',
    furnaceBulwark: '🧱 Firebox',
    furnaceSlinger: '🎯 Flue',
    furnacePrime: '⭐ The Bellows',
    hollowNative: 'Hollow Man',
    hollowBulwark: '🧱 Husk',
    hollowSlinger: '🎯 Absence',
    hollowPrime: '⭐ What Is Left',
  };
